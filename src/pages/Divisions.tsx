...
const divisions = [
  {
    ...
    description: 'From domain registration, cloud hosting, and email infrastructure to modern UI dashboards, AI chatbots, and startup technology roadmaps, Buildrex Tech provides complete digital solutions.',
    icon: Code2,
    services: [
